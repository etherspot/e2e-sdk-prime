...
describe('The PrimeSDK, when get the NFT List, Token List and Exchange Rates details with goerli network on the MainNet', function () {
  ...
  it('SMOKE: Validate the Token List on the goerli network', async function () {
    ...
    if (runTest) {
      ...
      console.warn(
        'DUE TO INSUFFICIENT WALLET BALANCE, SKIPPING TEST CASE OF THE TOKEN LIST ON THE goerli NETWORK',
      );
    }
  });
  ...
  it('SMOKE: Validate the Exchange Rates on the goerli network', async function () {
    ...
    if (runTest) {
      ...
      console.warn(
        'DUE TO INSUFFICIENT WALLET BALANCE, SKIPPING TEST CASE OF THE EXCHANGE RATE ON THE goerli NETWORK',
      );
    }
  });
