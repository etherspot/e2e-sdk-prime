...
describe('The PrimeSDK, when get the single transaction and multiple transaction details with mumbai network on the TestNet', function () {
      ...
      await customRetryAsync(async function () {
        ...
        if (!(userOpsReceipt === null)) {
          try {
            ...
            singleTransaction = await mumbaiDataService.getTransaction({
  ...
  it('SMOKE: Validate the get transactions history response with random transaction in mumbai network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
        ...
        try {
          transactions = await mumbaiDataService.getTransactions({
            chainId: Number(data.mumbai_chainid),
            account: data.sender
          });
  ...
  it('SMOKE: Validate the get transactions history response of the native transaction in mumbai network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('SMOKE: Validate the get transactions history response of the erc20 transaction in mumbai network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the get transaction history response with invalid hash on mumbai network', async function () {
    ...
    if (runTest) {
      await customRetryAsync(async function () {
        ...
        let transaction;
        try {
          transaction = await mumbaiDataService.getTransaction({
  ...
  it('REGRESSION: Validate the get transaction history response when hash hex is not with 32 size on mumbai network', async function () {
    ...
    if (runTest) {
      await customRetryAsync(async function () {
        ...
        // Fetching a single transaction
        try {
          await mumbaiDataService.getTransaction({
  ...
  it('REGRESSION: Validate the get transactions history response with invalid chainid in mumbai network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
        ...
        try {
          let transactions = await mumbaiDataService.getTransactions({
  ...
  it('REGRESSION: Validate the get transactions history response with invalid account in mumbai network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
        ...
        try {
          let a = await mumbaiDataService.getTransactions({
            chainId: Number(data.mumbai_chainid),
  ...
  it('REGRESSION: Validate the get transactions history response with incorrect account in mumbai network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
        ...
        try {
          await mumbaiDataService.getTransactions({
            chainId: Number(data.mumbai_chainid),
