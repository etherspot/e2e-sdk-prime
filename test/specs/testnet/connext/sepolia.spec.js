...
describe('The PrimeSDK, Validate the connext endpoints with sepolia network on the TestNet', function () {
  ...
  it('SMOKE: Validate the all supported assets with valid details on the sepolia network', async function () {
    var test = this;
  ...
  it('SMOKE: Validate the supported assets with valid details on the sepolia network', async function () {
    var test = this;
    let supportedAssets;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('SMOKE: Validate the get quotes with valid details on the sepolia network', async function () {
    var test = this;
    let quotes;
    if (runTest) {
      await customRetryAsync(async function () {
        ...
        try {
          quotes = await sepoliaDataService.getQuotes({
            ...
            fromChainId: data.sepolia_chainid,
            toChainId: data.matic_chainid,
            fromToken: data.tokenAddress_sepoliaUSDC,
  ...
  it('SMOKE: Validate the get transaction status with valid details on the sepolia network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
        ...
        try {
          transactionStatus = await sepoliaDataService.getTransactionStatus({
            fromChainId: data.sepolia_chainid,
            toChainId: data.matic_chainid,
  ...
  it('REGRESSION: Validate the supported assets with invalid chainid on the sepolia network', async function () {
    var test = this;
    let supportedAssets;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the get quotes with invalid sender address on the sepolia network', async function () {
    var test = this;
    let quotes;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the get quotes without sender address on the sepolia network', async function () {
    var test = this;
    let quotes;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the get quotes with incorrect sender address on the sepolia network', async function () {
    var test = this;
    let quotes;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the get quotes with invalid recepient address on the sepolia network', async function () {
    var test = this;
    let quotes;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the get quotes without recepient address on the sepolia network', async function () {
    var test = this;
    let quotes;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the get quotes with incorrect recepient address on the sepolia network', async function () {
    var test = this;
    let quotes;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the get quotes without fromChainid details on the sepolia network', async function () {
    var test = this;
    let quotes;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the get quotes without toChainid details on the sepolia network', async function () {
    var test = this;
    let quotes;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the get quotes with invalid from token address on the sepolia network', async function () {
    var test = this;
    let quotes;
    if (runTest) {
      await customRetryAsync(async function () {
        ...
        try {
          quotes = await sepoliaDataService.getQuotes({
            ...
            fromChainId: data.sepolia_chainid,
            toChainId: data.matic_chainid,
            fromToken: data.invalidTokenAddress_sepoliaUSDC,
            fromAmount: utils.parseUnits(data.swap_value, 18),
            slippage: 0.1,
            provider: BridgingProvider.Connext,
          });
  ...
  it('REGRESSION: Validate the get quotes with incorrect from token address on the sepolia network', async function () {
    var test = this;
    let quotes;
    if (runTest) {
      await customRetryAsync(async function () {
        ...
        try {
          quotes = await sepoliaDataService.getQuotes({
            ...
            fromChainId: data.sepolia_chainid,
            toChainId: data.matic_chainid,
            fromToken: data.incorrectTokenAddress_sepoliaUSDC,
            fromAmount: utils.parseUnits(data.swap_value, 18),
            slippage: 0.1,
            provider: BridgingProvider.Connext,
          });
  ...
  it('REGRESSION: Validate the get quotes without from token address on the sepolia network', async function () {
    var test = this;
    let quotes;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the get quotes with invalid value on the sepolia network', async function () {
    var test = this;
    let quotes;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the get quotes with small value on the sepolia network', async function () {
    var test = this;
    let quotes;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the get quotes without value on the sepolia network', async function () {
    var test = this;
    let quotes;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the get quotes without slippage on the sepolia network', async function () {
    var test = this;
    let quotes;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the get transaction status without fromChainId on the sepolia network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the get transaction status without toChainId on the sepolia network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
        ...
        try {
          transactionStatus = await sepoliaDataService.getTransactionStatus({
            fromChainId: data.invalid_sepolia_chainid,
            transactionHash: data.transactionHash,
            provider: BridgingProvider.Connext,
          });
  ...
  it('REGRESSION: Validate the get transaction status with invalid transactionHash on the sepolia network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the get transaction status with incorrect transactionHash on the sepolia network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the get transaction status without transactionHash on the sepolia network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
