...
describe('The PrimeSDK, when get cross chain quotes and get advance routes LiFi transaction details with matic network on the MainNet.', function () {
  ...
  xit('SMOKE: Perform the transfer native token with paymaster on the matic network', async function () {
    var test = this;
    if (runTest) {
        ...
        if (utils.isAddress(paymasterAddress)) {
          ...
          try {
            ...
            while (userOpsReceipt1 == null && Date.now() < timeout1) {
              ...
              userOpsReceipt1 = await maticMainNetSdk.getUserOpReceipt(uoHash1);
            }
  ...
  xit('REGRESSION: Perform the transfer native token with invalid paymaster url on the matic network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
        // clear the transaction batch
  ...
  xit('REGRESSION: Perform the transfer native token without paymaster url on the matic network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
        // clear the transaction batch
  ...
  xit('REGRESSION: Perform the transfer native token with invalid API Key on the matic network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
        // clear the transaction batch
  ...
  xit('REGRESSION: Perform the transfer native token with incorrect API Key on the matic network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
        // clear the transaction batch
  ...
  xit('REGRESSION: Perform the transfer native token without API Key on the matic network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
        // clear the transaction batch
  ...
  xit('REGRESSION: Perform the transfer native token with invalid context on the matic network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
        // clear the transaction batch
  ...
  xit('REGRESSION: Perform the transfer native token without context on the matic network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
        // clear the transaction batch
