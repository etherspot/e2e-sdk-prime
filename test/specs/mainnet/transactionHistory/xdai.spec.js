...
describe('The PrimeSDK, when get the single transaction and multiple transaction details with xdai network on the MainNet', function () {
  ...
  it('SMOKE: Validate the transaction history of the native token transaction on the xdai network', async function () {
    ...
    if (runTest) {
      ...
      console.warn(
        'DUE TO INSUFFICIENT WALLET BALANCE, SKIPPING TEST CASE OF THE HISTORY OF THE TRANSACTION ON THE xdai NETWORK',
      );
    }
  });
  ...
  it('SMOKE: Validate the get transactions history response of the native transaction in xdai network', async function () {
    ...
    if (runTest) {
      ...
      console.warn(
        'DUE TO INSUFFICIENT WALLET BALANCE, SKIPPING TEST CASE OF THE HISTORY OF THE TRANSACTIONS WITH RANDOM TRANSACTION ON THE xdai NETWORK',
      );
    }
  });
  ...
  it('SMOKE: Validate the get transactions history response of the erc20 transaction in xdai network', async function () {
    ...
    if (runTest) {
      ...
      console.warn(
        'DUE TO INSUFFICIENT WALLET BALANCE, SKIPPING TEST CASE OF THE HISTORY OF THE TRANSACTIONS WITH ERC20 TRANSACTION ON THE xdai NETWORK',
      );
    }
  });
  ...
  it('REGRESSION: Validate the get transactions history response with incorrect chainid in xdai network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
        try {
