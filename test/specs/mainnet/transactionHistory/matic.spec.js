...
describe('The PrimeSDK, when get the single transaction and multiple transaction details with matic network on the MainNet', function () {
  ...
  it('SMOKE: Validate the transaction history of the native token transaction on the matic network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('SMOKE: Validate the get transactions history response with random transaction in matic network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('SMOKE: Validate the get transactions history response of the native transaction in matic network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
        // clear the transaction batch
  ...
  it('SMOKE: Validate the get transactions history response of the erc20 transaction in matic network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the get transaction history response with invalid hash on matic network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the get transaction history response when hash hex is not with 32 size on matic network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
        // Fetching a single transaction
  ...
  it('REGRESSION: Validate the get transactions history response with invalid chainid in matic network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
        try {
          let transactions = await maticDataService.getTransactions({
  ...
  it('REGRESSION: Validate the get transactions history response with incorrect chainid in matic network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
        try {
  ...
  it('REGRESSION: Validate the get transactions history response with invalid account in matic network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
        try {
          let a = await maticDataService.getTransactions({
            chainId: Number(data.matic_chainid),
  ...
  it('REGRESSION: Validate the get transactions history response with incorrect account in matic network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
        try {
