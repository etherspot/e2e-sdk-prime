...
describe('The PrimeSDK, when transaction with arka and pimlico paymasters with matic network on the MainNet.', function () {
  ...
  it('SMOKE: Perform the transfer native token with paymaster on the matic network', async function () {
    var test = this;
    if (runTest) {
  ...
  it('SMOKE: Perform the transfer token with arka pimlico paymaster on the matic network', async function () {
    var test = this;
    ...
    if (runTest) {
      ...
      console.warn(
        'DUE TO INSUFFICIENT WALLET BALANCE, SKIPPING TEST CASE OF THE ARKA PIMLICO PAYMASTER ON THE matic NETWORK',
      );
    }
  });
  ...
  it('REGRESSION: Perform the transfer native token with invalid paymaster url on the matic network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
        // clear the transaction batch
      ...
      console.warn(
        'DUE TO INSUFFICIENT WALLET BALANCE, SKIPPING TEST CASE OF THE SEND NATIVE TOKEN WITH PAYMASTER ON THE matic NETWORK',
      );
    }
  });

  it('REGRESSION: Perform the transfer native token without paymaster url on the matic network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
        // clear the transaction batch
  ...
  it('REGRESSION: Perform the transfer native token with invalid API Key on the matic network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
        // clear the transaction batch
  ...
  it('REGRESSION: Perform the transfer native token with incorrect API Key on the matic network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
        // clear the transaction batch
  ...
  it('REGRESSION: Perform the transfer native token without API Key on the matic network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
        // clear the transaction batch
  ...
  it('REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid paymaster URL on the matic network', async function () {
    var test = this;
  ...
  it('REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid API Key in queryString on the matic network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
  ...
  it('REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid ChainID in queryString on the matic network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
    let queryString = `?apiKey=${process.env.API_KEY}&chainId=${Number(
  ...
  it('REGRESSION: Perform the transfer token on arka pimlico paymaster without ChainID in queryString on the matic network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
  ...
  it('REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid Entry Point Address while fetching the paymaster address on the matic network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
    let queryString = `?apiKey=${process.env.API_KEY}&chainId=${Number(
      data.matic_chainid,
  ...
  it('REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid token while fetching the paymaster address on the matic network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
    let queryString = `?apiKey=${process.env.API_KEY}&chainId=${Number(
      data.matic_chainid,
  ...
  it('REGRESSION: Perform the transfer token on arka pimlico paymaster without parameters while fetching the paymaster address on the matic network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
    let queryString = `?apiKey=${process.env.API_KEY}&chainId=${Number(
      data.matic_chainid,
  ...
  it('REGRESSION: Perform the transfer token on arka pimlico paymaster with incorrect token address of the erc20 contract on the matic network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
    let queryString = `?apiKey=${process.env.API_KEY}&chainId=${Number(
      data.matic_chainid,
  ...
  it('REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid token address of the erc20 contract on the matic network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
    let queryString = `?apiKey=${process.env.API_KEY}&chainId=${Number(
      data.matic_chainid,
  ...
  it('REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid paymaster address of the erc20 contract on the matic network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
    let queryString = `?apiKey=${process.env.API_KEY}&chainId=${Number(
      data.matic_chainid,
  ...
  it('REGRESSION: Perform the transfer token on arka pimlico paymaster with incorrect paymaster address of the erc20 contract on the matic network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
    let queryString = `?apiKey=${process.env.API_KEY}&chainId=${Number(
      data.matic_chainid,
  ...
  it('REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid value of the transactions on the matic network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
    let queryString = `?apiKey=${process.env.API_KEY}&chainId=${Number(
      data.matic_chainid,
  ...
  it('REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid paymaster URL while estimate the transactions on the matic network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
  ...
  it('REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid Api Key while estimate the transactions on the matic network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
    let queryString = `?apiKey=${process.env.API_KEY}&chainId=${Number(
      data.matic_chainid,
  ...
  it('REGRESSION: Perform the transfer token on arka pimlico paymaster without Api Key while estimate the transactions on the matic network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
    let queryString = `?apiKey=${process.env.API_KEY}&chainId=${Number(
      data.matic_chainid,
  ...
  it('REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid chainid while estimate the transactions on the matic network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
    let queryString = `?apiKey=${process.env.API_KEY}&chainId=${Number(
      data.matic_chainid,
  ...
  it('REGRESSION: Perform the transfer token on arka pimlico paymaster without chainid while estimate the transactions on the matic network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
    let queryString = `?apiKey=${process.env.API_KEY}&chainId=${Number(
      data.matic_chainid,
