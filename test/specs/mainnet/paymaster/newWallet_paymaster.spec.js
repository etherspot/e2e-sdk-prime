...
describe('Perform the transaction with arka and pimlico paymasters on the MainNet (with new wallet)', function () {
  ...
  it(
    'SMOKE: Perform the transfer token with arka pimlico paymaster on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
        ...
        await customRetryAsync(async function () {
          ...
          try {
            returnedValue = await fetch(
              `${arka_url}/pimlicoAddress${queryString}`,
              {
                ...
                body: JSON.stringify({
                  params: [data.entryPointAddress, { token: randomTokenName }],
                }),
              }
            ).then((res) => {
              return res.json();
          ...
          if (utils.isAddress(paymasterAddress)) {
            ...
            try {
              ...
              contract = await mainnetPrimeSdk.addUserOpsToBatch({
            ...
            try {
              approveOp = await mainnetPrimeSdk.estimate();
            ...
            // get the uoHash1
            try {
              uoHash1 = await mainnetPrimeSdk.send(approveOp);
            ...
            while (userOpsReceipt1 == null && Date.now() < timeout1) {
              helper.wait(data.mediumTimeout);
              userOpsReceipt1 = await mainnetPrimeSdk.getUserOpReceipt(uoHash1);
            }
            ...
            try {
              op = await mainnetPrimeSdk.estimate({
                paymasterDetails: {
                  ...
                  context: { token: randomTokenName, mode: 'erc20' },
                },
              });
  ...
  xit(
    'SMOKE: Perform the transfer token with arka paymaster with validUntil and validAfter on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  xit(
    'SMOKE: Validate the metadata of the arka paymaster on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  xit(
    'SMOKE: Validate the get token paymaster address function of the arka paymaster on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  xit(
    'SMOKE: Validate the remove whitelist address function of the arka paymaster on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  xit(
    'SMOKE: Validate the add whitelist address function of the arka paymaster on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  xit(
    'SMOKE: Validate the check whitelist function of the arka paymaster on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  xit(
    'SMOKE: Validate the deposit function of the arka paymaster on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  it(
    'REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid paymaster URL on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  it(
    'REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid API Key in queryString on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  it(
    'REGRESSION: Perform the transfer token on arka pimlico paymaster without API Key in queryString on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
      let arka_url = data.paymaster_arka;
      let queryString = `?chainId=${Number(randomChainId)}`; // without API Key in queryString
      if (runTest) {
        await customRetryAsync(async function () {
          let returnedValue;
  ...
  it(
    'REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid ChainID in queryString on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  it(
    'REGRESSION: Perform the transfer token on arka pimlico paymaster without ChainID in queryString on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  it(
    'REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid Entry Point Address while fetching the paymaster address on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  it(
    'REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid token while fetching the paymaster address on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  it(
    'REGRESSION: Perform the transfer token on arka pimlico paymaster without parameters while fetching the paymaster address on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  it(
    'REGRESSION: Perform the transfer token on arka pimlico paymaster with incorrect token address of the erc20 contract on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  it(
    'REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid token address of the erc20 contract on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  it(
    'REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid paymaster address of the erc20 contract on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  it(
    'REGRESSION: Perform the transfer token on arka pimlico paymaster with incorrect paymaster address of the erc20 contract on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  it(
    'REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid value of the transactions on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
      ...
      if (runTest) {
        await customRetryAsync(async function () {
          ...
          if (utils.isAddress(paymasterAddress)) {
            ...
            // get the uoHash1
            try {
              await mainnetPrimeSdk.send(approveOp);
            } catch (e) {
              console.error(e);
              const eString = e.toString();
              if (eString === 'Error') {
  ...
  it(
    'REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid paymaster URL while estimate the transactions on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  it(
    'REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid Api Key while estimate the transactions on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
      ...
      }&chainId=${Number(randomChainId)}`; // invalid API Key in queryString
      if (runTest) {
        await customRetryAsync(async function () {
          let returnedValue;
          let paymasterAddress;
  ...
  it(
    'REGRESSION: Perform the transfer token on arka pimlico paymaster without Api Key while estimate the transactions on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
      ...
      let invalid_queryString = `?chainId=${Number(randomChainId)}`; // without API Key in queryString
      if (runTest) {
        await customRetryAsync(async function () {
          let returnedValue;
          let paymasterAddress;
  ...
  it(
    'REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid chainid while estimate the transactions on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  it(
    'REGRESSION: Perform the transfer token on arka pimlico paymaster without chainid while estimate the transactions on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  xit(
    'REGRESSION: Perform the transfer token on arka paymaster with validUntil and validAfter with invalid paymaster URL on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  xit(
    'REGRESSION: Perform the transfer token on arka paymaster with validUntil and validAfter with invalid API Token on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  xit(
    'REGRESSION: Perform the transfer token on arka paymaster with validUntil and validAfter without API Token on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  xit(
    'REGRESSION: Perform the transfer token on arka paymaster with validUntil and validAfter with invalid ChainID on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  xit(
    'REGRESSION: Perform the transfer token on arka paymaster with validUntil and validAfter without ChainID on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  xit(
    'REGRESSION: Validate the get token paymaster address function of the arka paymaster with incorrect token on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  xit(
    'REGRESSION: Validate the get token paymaster address function of the arka paymaster without token on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  xit(
    'REGRESSION: Validate the remove whitelist address function of the arka paymaster with invalid address on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  xit(
    'REGRESSION: Validate the remove whitelist address function of the arka paymaster with incorrect address on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  xit(
    'REGRESSION: Validate the remove whitelist address function of the arka paymaster with random address on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  xit(
    'REGRESSION: Validate the remove whitelist address function of the arka paymaster with random and whitelisted addresses on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  xit(
    'REGRESSION: Validate the remove whitelist address function of the arka paymaster with multiple whitelisted addresses on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  xit(
    'REGRESSION: Validate the remove whitelist address function of the arka paymaster with multiple random addresses on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  xit(
    'REGRESSION: Validate the add whitelist address function of the arka paymaster with invalid address on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  xit(
    'REGRESSION: Validate the add whitelist address function of the arka paymaster with incorrect address on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  xit(
    'REGRESSION: Validate the add whitelist address function of the arka paymaster with random address on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  xit(
    'REGRESSION: Validate the add whitelist address function of the arka paymaster with random and whitelisted addresses on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  xit(
    'REGRESSION: Validate the add whitelist address function of the arka paymaster with multiple whitelisted addresses on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  xit(
    'REGRESSION: Validate the check whitelist function of the arka paymaster with invalid address on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  xit(
    'REGRESSION: Validate the check whitelist function of the arka paymaster with incorrect address on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  xit(
    'REGRESSION: Validate the check whitelist function of the arka paymaster with random address on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  xit(
    'REGRESSION: Validate the check whitelist function of the arka paymaster without address on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
  ...
  xit(
    'REGRESSION: Validate the deposit function of the arka paymaster with invalid amount on the ' +
      randomChainName +
      ' network',
    async function () {
      var test = this;
