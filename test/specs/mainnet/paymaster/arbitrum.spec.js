...
describe('The PrimeSDK, when transaction with arka and pimlico paymasters with arbitrum network on the MainNet.', function () {
  ...
  xit('SMOKE: Perform the transfer token with arka pimlico paymaster on the arbitrum network', async function () {
    var test = this;
    ...
    if (runTest) {
      await customRetryAsync(async function () {
        ...
        if (utils.isAddress(paymasterAddress)) {
          ...
          // get the uoHash1
          try {
            uoHash1 = await arbitrumMainNetSdk.send(approveOp);
  ...
  it('SMOKE: Perform the transfer token with arka paymaster with validUntil and validAfter on the arbitrum network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
    let queryString = `?apiKey=${process.env.API_KEY}&chainId=${Number(
      data.arbitrum_chainid,
  ...
  it.only('REGRESSION: Perform the transfer native token without arka paymaster url on the arbitrum network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
        // clear the transaction batch
  ...
  xit('REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid paymaster URL on the arbitrum network', async function () {
    var test = this;
  ...
  xit('REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid API Key in queryString on the arbitrum network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
  ...
  xit('REGRESSION: Perform the transfer token on arka pimlico paymaster without API Key in queryString on the arbitrum network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
    let queryString = `?chainId=${Number(data.arbitrum_chainid)}`; // without API Key in queryString
    if (runTest) {
      await customRetryAsync(async function () {
        let returnedValue;
  ...
  xit('REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid ChainID in queryString on the arbitrum network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
    let queryString = `?apiKey=${process.env.API_KEY}&chainId=${Number(
      data.invalid_arbitrum_chainid,
  ...
  xit('REGRESSION: Perform the transfer token on arka pimlico paymaster without ChainID in queryString on the arbitrum network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
  ...
  xit('REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid Entry Point Address while fetching the paymaster address on the arbitrum network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
    let queryString = `?apiKey=${process.env.API_KEY}&chainId=${Number(
      data.arbitrum_chainid,
  ...
  xit('REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid token while fetching the paymaster address on the arbitrum network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
    let queryString = `?apiKey=${process.env.API_KEY}&chainId=${Number(
      data.arbitrum_chainid,
  ...
  xit('REGRESSION: Perform the transfer token on arka pimlico paymaster without parameters while fetching the paymaster address on the arbitrum network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
    let queryString = `?apiKey=${process.env.API_KEY}&chainId=${Number(
      data.arbitrum_chainid,
  ...
  xit('REGRESSION: Perform the transfer token on arka pimlico paymaster with incorrect token address of the erc20 contract on the arbitrum network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
    let queryString = `?apiKey=${process.env.API_KEY}&chainId=${Number(
      data.arbitrum_chainid,
  ...
  xit('REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid token address of the erc20 contract on the arbitrum network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
    let queryString = `?apiKey=${process.env.API_KEY}&chainId=${Number(
      data.arbitrum_chainid,
  ...
  xit('REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid paymaster address of the erc20 contract on the arbitrum network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
    let queryString = `?apiKey=${process.env.API_KEY}&chainId=${Number(
      data.arbitrum_chainid,
  ...
  xit('REGRESSION: Perform the transfer token on arka pimlico paymaster with incorrect paymaster address of the erc20 contract on the arbitrum network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
    let queryString = `?apiKey=${process.env.API_KEY}&chainId=${Number(
      data.arbitrum_chainid,
  ...
  xit('REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid value of the transactions on the arbitrum network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
    let queryString = `?apiKey=${process.env.API_KEY}&chainId=${Number(
      data.arbitrum_chainid,
  ...
  xit('REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid paymaster URL while estimate the transactions on the arbitrum network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
  ...
  xit('REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid Api Key while estimate the transactions on the arbitrum network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
    let queryString = `?apiKey=${process.env.API_KEY}&chainId=${Number(
      data.arbitrum_chainid,
    ...
    let invalid_queryString = `?apiKey=${process.env.INVALID_API_KEY
      }&chainId=${Number(data.arbitrum_chainid)}`; // invalid API Key in queryString
    if (runTest) {
      await customRetryAsync(async function () {
        let returnedValue;
        let paymasterAddress;
  ...
  xit('REGRESSION: Perform the transfer token on arka pimlico paymaster without Api Key while estimate the transactions on the arbitrum network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
    let queryString = `?apiKey=${process.env.API_KEY}&chainId=${Number(
      data.arbitrum_chainid,
    )}`;
    let invalid_queryString = `?chainId=${Number(data.arbitrum_chainid)}`; // without API Key in queryString
    if (runTest) {
      await customRetryAsync(async function () {
        let returnedValue;
        let paymasterAddress;
  ...
  xit('REGRESSION: Perform the transfer token on arka pimlico paymaster with invalid chainid while estimate the transactions on the arbitrum network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
    let queryString = `?apiKey=${process.env.API_KEY}&chainId=${Number(
      data.arbitrum_chainid,
  ...
  xit('REGRESSION: Perform the transfer token on arka pimlico paymaster without chainid while estimate the transactions on the arbitrum network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
    let queryString = `?apiKey=${process.env.API_KEY}&chainId=${Number(
      data.arbitrum_chainid,
  ...
  it('REGRESSION: Perform the transfer token on arka paymaster with validUntil and validAfter with invalid paymaster URL on the arbitrum network', async function () {
    var test = this;
    let invalid_arka_url = data.invalid_paymaster_arka;
    let queryString = `?apiKey=${process.env.API_KEY}&chainId=${Number(
      data.arbitrum_chainid,
  ...
  it('REGRESSION: Perform the transfer token on arka paymaster with validUntil and validAfter with invalid API Token on the arbitrum network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
    let invalid_queryString = `?apiKey=${process.env.INVALID_API_KEY
      }&chainId=${Number(data.arbitrum_chainid)}`; // invalid API Key in queryString
  ...
  it('REGRESSION: Perform the transfer token on arka paymaster with validUntil and validAfter without API Token on the arbitrum network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
    let invalid_queryString = `?chainId=${Number(data.arbitrum_chainid)}`; // without API Key in queryString
    if (runTest) {
  ...
  it('REGRESSION: Perform the transfer token on arka paymaster with validUntil and validAfter with invalid ChainID on the arbitrum network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
    let invalid_queryString = `?apiKey=${process.env.API_KEY}&chainId=${Number(
      data.invalid_arbitrum_chainid,
  ...
  it('REGRESSION: Perform the transfer token on arka paymaster with validUntil and validAfter without ChainID on the arbitrum network', async function () {
    var test = this;
    let arka_url = data.paymaster_arka;
