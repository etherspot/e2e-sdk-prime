...
describe('The PrimeSDK, when transaction with arka and pimlico paymasters with optimism network on the MainNet.', function () {
  before(async function () {
    ...
    await customRetryAsync(async function () {
      ...
      try {
        arkaPaymaster = new ArkaPaymaster(Number(data.optimism_chainid), process.env.API_KEY, data.paymaster_arka);
      } catch (e) {
        console.error(e);
        const eString = e.toString();
        addContext(test, eString);
  ...
  it('SMOKE: Perform the transfer native token on arka paymaster on the optimism network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
      ...
      console.warn(
        'DUE TO INSUFFICIENT WALLET BALANCE, SKIPPING TEST CASE OF THE ARKA FUNCTION ON THE optimism NETWORK',
      );
    }
  });
  ...
  it('SMOKE: Validate the metadata of the arka paymaster on the optimism network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('SMOKE: Validate the get token paymaster address function of the arka paymaster on the optimism network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('SMOKE: Validate the remove whitelist address function of the arka paymaster on the optimism network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('SMOKE: Validate the add whitelist address function of the arka paymaster on the optimism network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('SMOKE: Validate the check whitelist function of the arka paymaster on the optimism network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('SMOKE: Validate the deposit function of the arka paymaster on the optimism network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Perform the transfer native token with invalid arka paymaster url on the optimism network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
        // clear the transaction batch
      ...
      console.warn(
        'DUE TO INSUFFICIENT WALLET BALANCE, SKIPPING TEST CASE OF THE ARKA FUNCTION WITH PAYMASTER ON THE optimism NETWORK',
      );
    }
  });

  it('REGRESSION: Perform the transfer native token without arka paymaster url on the optimism network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
        // clear the transaction batch
  ...
  it('REGRESSION: Perform the transfer native token with incorrect API Key of arka paymaster on the optimism network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
        // clear the transaction batch
  ...
  it('REGRESSION: Perform the transfer native token without API Key of arka paymaster on the optimism network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
        // clear the transaction batch
  ...
  it('REGRESSION: Validate the get token paymaster address function of the arka paymaster with incorrect token on the optimism network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the get token paymaster address function of the arka paymaster without token on the optimism network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the remove whitelist address function of the arka paymaster with invalid address on the optimism network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the remove whitelist address function of the arka paymaster with incorrect address on the optimism network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the remove whitelist address function of the arka paymaster with random address on the optimism network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the remove whitelist address function of the arka paymaster without address on the optimism network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the remove whitelist address function of the arka paymaster with random and whitelisted addresses on the optimism network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the remove whitelist address function of the arka paymaster with multiple whitelisted addresses on the optimism network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the remove whitelist address function of the arka paymaster with multiple random addresses on the optimism network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the add whitelist address function of the arka paymaster with invalid address on the optimism network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the add whitelist address function of the arka paymaster with incorrect address on the optimism network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the add whitelist address function of the arka paymaster with random address on the optimism network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the add whitelist address function of the arka paymaster without address on the optimism network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the add whitelist address function of the arka paymaster with random and whitelisted addresses on the optimism network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the add whitelist address function of the arka paymaster with multiple whitelisted addresses on the optimism network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the check whitelist function of the arka paymaster with invalid address on the optimism network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the check whitelist function of the arka paymaster with incorrect address on the optimism network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the check whitelist function of the arka paymaster with random address on the optimism network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the check whitelist function of the arka paymaster without address on the optimism network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Validate the deposit function of the arka paymaster with invalid amount on the optimism network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
