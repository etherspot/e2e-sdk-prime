...
describe('The PrimeSDK, when get the single transaction and multiple transaction details with arbitrum network on the MainNet', () => {
  ...
  xit('SMOKE: Validate the transaction history of the native token transaction on the arbitrum network', async () => {
  ...
  it('REGRESSION: Validate the get transactions history response with invalid chainid in arbitrum network', async () => {
    try {
  ...
  it('REGRESSION: Validate the get transactions history response with incorrect chainid in arbitrum network', async () => {
    try {
      await arbitrumMainNetSdk.getTransactions({
  ...
  it('REGRESSION: Validate the get transactions history response with invalid account in arbitrum network', async () => {
    try {
      await arbitrumMainNetSdk.getTransactions({
        chainId: Number(process.env.ARBITRUM_CHAINID),
  ...
  it('REGRESSION: Validate the get transactions history response with incorrect account in arbitrum network', async () => {
    try {
      await arbitrumMainNetSdk.getTransactions({
        chainId: Number(process.env.ARBITRUM_CHAINID),
