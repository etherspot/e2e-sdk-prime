...
describe('The PrimeSDK, when transfer a token with arbitrum network on the MainNet', () => {
  ...
  it('REGRESSION: Perform the transfer native token with the incorrect TxHash while getting the transaction hash on the arbitrum network', async () => {
    if (runTest) {
      ...
      console.warn(
        'DUE TO INSUFFICIENT WALLET BALANCE, SKIPPING TEST CASE OF THE SEND NATIVE TOKEN WITH THE INCORRECT TXHASH WHILE GETTING THE TRANSACTION HASH ON THE ARBITRUM NETWORK',
      );
    }
  });
  ...
  it('REGRESSION: Perform the transfer native token with the past TxHash while getting the transaction hash on the arbitrum network', async () => {
    if (runTest) {
      ...
      console.warn(
        'DUE TO INSUFFICIENT WALLET BALANCE, SKIPPING TEST CASE OF THE SEND NATIVE TOKEN WITH THE PAST TXHASH WHILE GETTING THE TRANSACTION HASH ON THE ARBITRUM NETWORK',
      );
    }
  });
  ...
  xit('REGRESSION: Perform the transfer ERC20 token with exceeded value while Getting the transferFrom encoded data on the arbitrum network', async () => {
    if (runTest) {
      ...
      console.warn(
        'DUE TO INSUFFICIENT WALLET BALANCE, SKIPPING TEST CASE OF THE SEND ERC20 TOKEN WITH EXCEEDED VALUE WHILE GETTING THE TRANSFERFROM ENCODED DATA ON THE ARBITRUM NETWORK',
      );
    }
  });
  ...
  xit('REGRESSION: Perform the transfer ERC20 token with same recipient i.e. sender address while Getting the transferFrom encoded data on the arbitrum network', async () => {
    if (runTest) {
      ...
      console.warn(
        'DUE TO INSUFFICIENT WALLET BALANCE, SKIPPING TEST CASE OF THE SEND ERC20 TOKEN WITH SAME RECEPIENT WHILE GETTING THE TRANSFERFROM ENCODED DATA ON THE ARBITRUM NETWORK',
      );
    }
  });
  ...
  xit('REGRESSION: Perform the transfer ERC20 token without transactionData while adding transactions to the batch on the arbitrum network', async () => {
    if (runTest) {
      ...
      console.warn(
        'DUE TO INSUFFICIENT WALLET BALANCE, SKIPPING TEST CASE OF THE SEND ERC20 TOKEN WITHOUT TRANSACTIONDATA WHILE ADDING TRANSACTION TO THE BATCH ON THE ARBITRUM NETWORK',
      );
    }
  });
  ...
  xit('REGRESSION: Perform the transfer ERC721 NFT token with same sender address while creating the NFT Data on the arbitrum network', async () => {
    if (runTest) {
      ...
      console.warn(
        'DUE TO INSUFFICIENT WALLET BALANCE, SKIPPING TEST CASE OF THE SEND ERC721 TOKEN WITH SAME SENDER ADDRESS WHILE ESTIMATE THE ADDED THE TRANSACTIONS TO THE BATCH ON THE ARBITRUM NETWORK',
      );
    }
  });
  ...
  xit('REGRESSION: Perform the transfer ERC721 NFT token with same recipient address while creating the NFT Data on the arbitrum network', async () => {
    if (runTest) {
      ...
      console.warn(
        'DUE TO INSUFFICIENT WALLET BALANCE, SKIPPING TEST CASE OF THE SEND ERC721 TOKEN WITH SAME RECEPIENT ADDRESS WHILE ESTIMATE THE ADDED THE TRANSACTIONS TO THE BATCH ON THE ARBITRUM NETWORK',
      );
    }
  });
