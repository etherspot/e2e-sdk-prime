...
describe('The PrimeSDK, when transfer a token with matic network on the MainNet', () => {
  beforeEach(async () => {
    // added timeout
  ...
  it('REGRESSION: Perform the transfer native token with the incorrect TxHash while getting the transaction hash on the matic network', async () => {
    if (runTest) {
      ...
      console.warn(
        'DUE TO INSUFFICIENT WALLET BALANCE, SKIPPING TEST CASE OF THE SEND NATIVE TOKEN WITH THE INCORRECT TXHASH WHILE GETTING THE TRANSACTION HASH ON THE matic NETWORK',
      );
    }
  });
  ...
  it('REGRESSION: Perform the transfer native token with the past TxHash while getting the transaction hash on the matic network', async () => {
    if (runTest) {
      ...
      console.warn(
        'DUE TO INSUFFICIENT WALLET BALANCE, SKIPPING TEST CASE OF THE SEND NATIVE TOKEN WITH THE PAST TXHASH WHILE GETTING THE TRANSACTION HASH ON THE matic NETWORK',
      );
    }
  });
  ...
  it('REGRESSION: Perform the transfer ERC20 token with the incorrect Token Address while adding transactions to the batch on the matic network', async () => {
    if (runTest) {
      // get the respective provider details
      let provider;
      try {
  ...
  it('REGRESSION: Perform the transfer ERC20 token with the incorrect TxHash while getting the transaction hash on the matic network', async () => {
    if (runTest) {
      ...
      console.warn(
        'DUE TO INSUFFICIENT WALLET BALANCE, SKIPPING TEST CASE OF THE SEND ERC20 TOKEN WITH INCORRECT TXHASH WHILE GETTING THE TRANSACTION HASH ON THE matic NETWORK',
      );
    }
  });
  ...
  it('REGRESSION: Perform the transfer ERC20 token with the past TxHash while getting the transaction hash on the matic network', async () => {
    if (runTest) {
      ...
      console.warn(
        'DUE TO INSUFFICIENT WALLET BALANCE, SKIPPING TEST CASE OF THE SEND ERC20 TOKEN WITH PAST TXHASH WHILE GETTING THE TRANSACTION HASH ON THE matic NETWORK',
      );
    }
  });
  ...
  it('REGRESSION: Perform the transfer ERC721 NFT Token with the incorrect TxHash while getting the transaction hash on the matic network', async () => {
    if (runTest) {
      ...
      console.warn(
        'DUE TO INSUFFICIENT WALLET BALANCE, SKIPPING TEST CASE OF THE SEND ERC721 TOKEN WITH INCORRECT TXHASH WHILE GETTING THE TRANSACTION HASH ON THE matic NETWORK',
      );
    }
  });
  ...
  it('REGRESSION: Perform the transfer ERC721 NFT Token with the past TxHash while getting the transaction hash on the matic network', async () => {
    if (runTest) {
      ...
      console.warn(
        'DUE TO INSUFFICIENT WALLET BALANCE, SKIPPING TEST CASE OF THE SEND ERC721 TOKEN WITH PAST TXHASH WHILE GETTING THE TRANSACTION HASH ON THE matic NETWORK',
      );
    }
  });
});
